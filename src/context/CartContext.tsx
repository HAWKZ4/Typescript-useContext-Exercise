...
const reducer = (
  ...
  switch (action.type) {
    case REDUCER_ACTION_TYPE.ADD: {
      ...
      const filteredCart = state.cart.filter((product) => product.sku !== sku);

      const itemExists = state.cart.find((product) => product.sku === sku);
    ...
    case REDUCER_ACTION_TYPE.QUANTITY:
      ...
      return { ...filteredProducts, cart: [...filteredProducts, updatedItem] };
